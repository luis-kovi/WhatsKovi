...
export function ThemeToggle() {
  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      {open && (
        <div className="absolute right-0 z-20 mt-3 w-64 rounded-2xl border border-gray-200 bg-white p-3 shadow-xl transition-all dark:border-slate-700 dark:bg-slate-900">
